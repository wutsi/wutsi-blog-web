...
import com.wutsi.blog.app.model.OAuth2UserModel
...
class OAuth2UserMapper {
    fun toUserModel(auth: Authentication): OAuth2UserModel {
    ...
    private fun toUserModelFromGithub(attrs: Map<String, Any>, provider: String) = OAuth2UserModel(
    ...
    private fun toUserModelFromFacebook(attrs: Map<String, Any>, provider: String) = OAuth2UserModel(
            id = attrs["id"].toString(),
    ...
    private fun toUserModelFromTwitter(attrs: Map<String, Any>, provider: String) = OAuth2UserModel(
            id = attrs["id"].toString(),
            fullName = attrs["name"].toString(),
